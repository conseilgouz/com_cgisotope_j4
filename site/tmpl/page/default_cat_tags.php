...
foreach ($layouts_order as $layout) {
	...
	if ($offcanvas && !$offcanvasopened) {// offcanvas
	    ...
	    echo '<a class="'.$button_bootstrap.' btn-info navbar-dark '.$offcanvaspos.'" data-bs-toggle="offcanvas" href="#offcanvas_isotope" role="button" aria-controls="offcanvas_isotope" title="Filtre" id="offcanvas-hamburger-btn">';
	    ...
	    echo '<div class="offcanvas offcanvas-start"  tabindex="-1" id="offcanvas_isotope" aria-labelledby="offcanvas_isotopeLabel" data-bs-scroll="true">';
